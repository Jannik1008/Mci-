...
#Excel einlesen
folder_path = r'.idea\Blatt_3\Daten_C1'
...
fig = px.scatter(combined_df, x='id', y='mt', title='C1 graph')
...
fig.add_traces(px.line(x=combined_df['id'], y = predictions, title='C1 graph').data)
fig.show()